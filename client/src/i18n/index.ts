...
export const LOCALE_CHANGED_EVENT = 'client:locale-changed'
...
export async function bootstrapI18n() {
  try {
    ...
    runtimeMessages.value = parseLocaleMessages(data.client_i18n_messages)
    refreshKnownMessages()
    const defaultLocale = data.client_default_locale || data.default_locale
